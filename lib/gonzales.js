...
{
  kern_return_t (* enumerator) (task_t task, void * user_data, unsigned type_mask, vm_address_t zone_address, memory_reader_t reader,
        ...
        guint * count)
{
  ...
  for (i = 0; i != malloc_zone_count; i++)
  {
    ...
    {
      zone->introspect->enumerator (selfTask, &ctx, MALLOC_PTR_IN_USE_RANGE_TYPE, zone_address, read_local_memory,
